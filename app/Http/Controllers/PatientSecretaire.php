...
class PatientSecretaire extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('patientsSecretaire.index', compact('patients'));
    }

    public function create()
    {
        return view('patientsSecretaire.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('patientsSecretaire.index')
    ...
    public function show($id)
    {
        ...
        return view('patientsSecretaire.show', compact('patient'));
    }

    public function edit($id)
    {
        $patient = Patient::findOrFail($id);
        return view('patientsSecretaire.edit', compact('patient'));
    }
